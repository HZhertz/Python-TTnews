...
// async function get_a_bogus(arguments) {
//   var r = window._U._v
//   // console.log(r)
//   return window._U._u(r[0], arguments, r[1], r[2], null)
// }

function get_a_bogus(arguments, r) {
  // console.log(r)
  return window._U._u(r[0], arguments, r[1], r[2], null)
}
...
for (const [key, value] of Object.entries(channelIdObj)) {
  arg[3] = `channel_id=${value}&min_behot_time=0&offset=0&category=pc_profile_channel&client_extra_params=%7B%22short_video_item%22%3A%22filter%22%7D&aid=24&app_name=toutiao_web`
